                     ...
                     <ListGroupItem key={item.id} onClick={() => this.toggle(item)}>
                        <Media className="row-relative">
                           ...
                           <Media body className="pl-3">
                              ...
                              <p className="text-warning ts-4">Release date: {item.release_date}</p>
                              <p className="text-muted ts-4 posB-0">Genre: {this.getGenre(item.genre_ids)}</p>
                           </Media>
                        </Media>
                     </ListGroupItem>
                  ))}
